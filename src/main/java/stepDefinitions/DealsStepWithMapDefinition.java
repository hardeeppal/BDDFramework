...
//        driver.findElement(By.xpath("//a[contains(text(),'New Contact')]")).click();
    ...
    public void user_enters_contactDetails_and_and(DataTable dealDetails) {
        for (Map<String, String> mapData : dealDetails.asMaps(String.class, String.class)) { // Raw method will give me list of string
            // Write code here that turns the phrase above into concrete actions
            driver.findElement(By.cssSelector("input[name='title']")).sendKeys(mapData.get("title"));
            driver.findElement(By.cssSelector("input[name='amount']")).sendKeys(mapData.get("amount"));
            driver.findElement(By.cssSelector("input[name='probability']")).sendKeys(mapData.get("probability"));
            driver.findElement(By.cssSelector("input[name='commission']")).sendKeys(mapData.get("commission"));
